...
locals {
  github-repo = "https://github.com/c9125serkanyavuz/session4-phonebook.git"
  github-file-url = "https://raw.githubusercontent.com/c9125serkanyavuz/session4-phonebook/master/"
}
...
resource "aws_ecr_repository" "ecr-repo" {
  name                 = "serkan-clarusway-repo/phonebook-app"
